...
editconf -f ${prot}-CG.pdb -o ${prot}-CG.box.pdb -box 40 40 15   >&  edc
...
#genbox -cp vacuum_min.gro -ci ../DSPE_single.gro -nmol 2700 -try 500 -o PE.gro -vdwd 0.21 >& box1

genbox -cp ${prot}-CG.box.pdb -ci ../DSPE_single.gro -nmol 2700 -try 500 -o PE.gro -vdwd 0.21 >& box1

editconf -f  PE.gro -o  PE.box.gro -box 40 40 25 >& edc2
genbox -cp PE.box.gro -ci ../CL_single.gro -nmol 300 -try 500 -o PECL.gro -vdwd 0.21 >& box2
...
$GMX51 grompp -f equilibration_2.mdp -c equilibration_1.gro -p ${prot}.top -o equilibration_2.tpr -n memsol.ndx -maxwarn 2 >& gp6
$GMX51 mdrun -deffnm equilibration_2 -v >& md5  # Takes about 150 minutes on 1 CPU
END
$GMX51 grompp -c equilibration_2.gro -f equilibration_3.mdp -p ${prot}.top -o equilibration_3 -n memsol.ndx  -maxwarn 2 >& gp7
